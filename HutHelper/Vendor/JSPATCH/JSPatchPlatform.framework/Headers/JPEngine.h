...
#define JPEngine B4E5
#define JPBoxing BO52x5
#define JPExtension BExt422
#define evaluateScriptWithPath evscflop
#define startEngine stej23
#define defineStruct dfs233
#define addExtensions adNacubai
#define handleException hdciw24j
