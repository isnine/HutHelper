//
//  JSPatch.h
//  JSPatch Platform SDK version 1.7.3
//
...
#define JSPatch EbaTestCode
#define startWithAppKey stwa43
#define setupRSAPublicKey strs4133x
#define setupTestScriptFileName sttscfi33
#define updateConfigWithAppKey udcfwak
#define testScriptInBundle testscjsinbund
#define JPCallbackType jtpjfksp
#define JPErrorCode DRerskcos
