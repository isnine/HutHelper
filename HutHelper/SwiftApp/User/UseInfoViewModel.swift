...
extension UseInfoViewModel {
    // 获取所有班级
    func getAllClassesRequst(callback: @escaping () -> ()){
    ...
    // 修改个人信息
    func alterUseInfo(type:UserInfoAPI,callback: @escaping (_ result:Bool) -> ()) {
    ...
    // 修改头像
    func alterUseHeadImg(image:UIImage,callback: @escaping (_ result:String?) -> ()){
