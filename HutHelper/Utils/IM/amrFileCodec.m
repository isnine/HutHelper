...
NSData* EncodePCMToAMR(char* data, int maxLen,int nChannels, int nBitsPerSample)
{
    ...
    [outData appendBytes:AMR_MAGIC_NUMBER length:strlen(AMR_MAGIC_NUMBER)];
	...
	while(1)
        ...
        [outData appendBytes:amrFrame length:byte_counter];
        }
...
//    [outData writeToFile:wavFile atomically:YES];
//#endif
...
//    NSLog(@"documentPath=%@", documentPath);
    ...
    return EncodePCMToAMR((char*)buf,maxLen- nPos,nChannels,nBitsPerSample);
}
