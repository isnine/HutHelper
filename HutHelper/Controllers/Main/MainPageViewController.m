...
- (void)SetTimeLabel{
    ...
    [APIRequest GET:[Config getApiWeather] parameters:nil
            success:^(id responseObject) {
                ...
                NSLog(@"%@",nowDic);
                UILabel *weatherLab=[[UILabel alloc]initWithFrame:CGRectMake(SYReal(322), SYReal_Y(55), SYReal(150), SYReal(60))];
                ...
                UILabel *weatherTextLab=[[UILabel alloc]initWithFrame:CGRectMake(SYReal(322), SYReal_Y(81), SYReal(150), SYReal(60))];
...
-(void)drawCalendar:(NSArray*)calendarArray{
    ...
    for (int i=0,j=0; i<calendarArray.count&&j<4; i++) {
        ...
        //绘制图形
        PointView *pointView=[[PointView alloc]initWithFrame:CGRectMake(SYReal(80+xSum+xfirstSum), SYReal_Y(225), SYReal(30), SYReal(30))];
        [self.view addSubview:pointView];
        UILabel *calendarTimeLabel=[[UILabel alloc]initWithFrame:CGRectMake(SYReal(60+xSum+xfirstSum), SYReal_Y(210), SYReal(100), SYReal(20))];
        ...
        UILabel *calendarNameLabel=[[UILabel alloc]initWithFrame:CGRectMake(SYReal(60+xSum+xfirstSum), SYReal_Y(243), SYReal(100), SYReal(20))];
