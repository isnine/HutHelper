...
static const int kPhotoTopWidth=380;//图片宽度
static const int kPhotoTopHeight=kPhotoTopWidth/1.6;//图片高度
static const int kPhotoTop2_x=kPhotoTopWidth+2;//右边图片起始x坐标
static const int kLabelTop_x=kPhotoTop2_x+10;//右边Label起始x坐标
static const int kLabelTop_y=kPhotoTopHeight-22;//label起始y坐标
static const int kLabelTop2_y=kPhotoTopHeight-8;
...
-(void)drawLeft{
    ...
    [leftImg sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:API_IMG,_dataLeft.img]]
...
-(void)drawRight{
    ...
    [rightImg sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:API_IMG,_dataRight.img]]
                placeholderImage:[UIImage imageNamed:@"load_img"]];
    ...
    rightLabel2.text=[_dataRight.vedioList[0] objectForKey:@"title"];
...
-(void)drawTop{
    /**顶部图片*/
    NSLog(@"%@",_dataLeft);
    leftImg=[[UIImageView alloc]initWithFrame:CGRectMake(SYReal(5), SYReal(5), SYReal(kPhotoTopWidth), SYReal(kPhotoTopHeight))];
    [leftImg sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:API_IMG,_dataLeft.img]]
               placeholderImage:[UIImage imageNamed:@"load_img"]];
    [self.contentView addSubview:leftImg];
    /**左边按钮*/
